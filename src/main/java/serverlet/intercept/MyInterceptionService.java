...
import serverlet.providers.StringProvider;
import serverlet.resources.ServerResource;
    ...
    public Filter getDescriptorFilter() {
        ...
        return new Filter() {
            ...
            public boolean matches(final Descriptor d) {
                ...
                return clazz.startsWith("serverlet.resources")
                        || clazz.startsWith("serverlet.providers");
            }
        };
    }
